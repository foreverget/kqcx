	...
	require(
			...
			function() {
				...
				var createHtml0 = function(loadType,flg) {
					...
					var __html = '';
					var _action = '/order/getYcOrder?type=1&page=' + page_0 + '&size=' + size + '&openId='+openId;
					// 发送请求获取更多数据
					$.ajax({
						type : 'GET',
						async: false,
				...
				var createHtml1 = function(loadType,flg) {
					...
					var __html = '';
					var _action = '/order/getYcOrder?type=2&page=' + page_1 + '&size=' + size + '&openId='+openId;
					// 发送请求获取更多数据
					$.ajax({
						type : 'GET',
						async: false,
				...
				var createHtml2 = function(loadType,flg) {
					...
					var __html = '';
					var _action = '/order/getYcOrder?type=3&page=' + page_2 + '&size=' + size + '&openId='+openId;
					// 发送请求获取更多数据
					$.ajax({
						type : 'GET',
						async: false,
